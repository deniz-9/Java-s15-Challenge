...
import com.librarysystem.users.Author;
...
public class Main {
    ...
    private static Library library = new Library(); // Composition: Main sınıfı Library sınıfını kullanıyor
...
/*
        ...
        librarian.whoYouAre();  // Kütüphaneci kendisini tanıtır
        //System.out.println(librarian.toString());


        List<Book> authorBooks = new ArrayList<>();  // Örnek bir kitap listesi oluştur
        Author author = new Author("John Doe", authorBooks);  // Yazar objesi oluştur
        author.whoYouAre();  // Yazarın kendisini tanıttığı metodu çağır
*/
        ...
        // Önceden tanımlı üye
        MemberRecord predefinedMember = new MemberRecord("1", MemberType.READER, "11-12-2023", 0, 5,"Deniz", "Kocaeli", "123456789");
        library.addMember(predefinedMember);

        // Önceden tanımlı kitaplar
        library.newBook("1", "Dune", "Frank Herbert", 149.99, "1965", "12.12.2023");
        library.newBook("2", "Vakıf", "Isaac Asimov", 299.99, "1942", "13.12.2023");
        library.newBook("3", "Kırmızı ve Siyah", "Stendhal", 110, "1830", "14.12.2023");
        library.newBook("4", "Savaş ve Barış", "Lev Tolstoy", 135.50, " 1867", "15.12.2023");
        library.newBook("5", "Suç ve Ceza", "Fyodor Dostoyevski", 90, "1866", "16.12.2023");
        library.newBook("6", "İki Şehrin Hikayesi", "Charles Dickens", 74.80, "1859", "17.12.2023");
        library.newBook("7", "Faust", "Goethe", 165, "1808", "18.12.2023");
        library.newBook("8", "Dijital Kale", "Dan Brown", 190, "1998", "19.12.2023");
        library.newBook("9", "Martin Eden", "Jack London", 54.50, "1909", "20.12.2023");
        library.newBook("10", "Satranç", "Stefan Zweig", 12.90, "1943", "21.12.2023");
    ...
    private static void removeBook() {
        ...
        boolean success = library.removeBookById(bookID); 
        if (success) {
